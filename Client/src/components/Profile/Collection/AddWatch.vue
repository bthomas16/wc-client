<template>
    <b-container>
            ...
            <b-row align-h="center" align-v="center" :class="addWatchCount == 1 ? '' : 'hidden'">
            ...
            <b-row align-h="start" id="add-specs" :class="addWatchCount == 2 ? '' : 'hidden'">
            ...
            <b-row :class="addWatchCount == 3 ? '' : 'hidden'" align-h="center">
                <b-col cols="12">
            ...
            <b-row id="add-keeping-house" :class="addWatchCount == 4 ? '' : 'hidden'">
