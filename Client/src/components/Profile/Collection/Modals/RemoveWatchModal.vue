<template>
    <b-container fluid>
        ...
        <b-row no-gutters v-if="removeWatchCount == 1" align-h="center">
        ...
        <b-form-row v-if="reasonsWatchMoved.typeMoved == 'sale'" class="mt-2 mt-md-4 w-100 mw-100">
            <b-form-group id=""
                ...
                <b-form-input id="inputHorizontal" placeholder="Johnny Cash" v-model="reasonsWatchMoved.watchReceivedBy"></b-form-input>
            </b-form-group>
            <b-form-group id=""
                horizontal
                :label-cols="5"
        ...
        <b-row no-gutters v-if="reasonsWatchMoved.typeMoved == 'trade'" class="mt-2 mt-md-4">
            <b-form-group id=""
                ...
                label-for="inputHorizontal">
                <b-form-input id="inputHorizontal" placeholder="John Smith" v-model="reasonsWatchMoved.watchReceivedBy"></b-form-input>
            </b-form-group>
            <b-form-group id=""
                horizontal
                :label-cols="5"
            ...
            <b-form-group id=""
                ...
                <ul>
                    <li v-for="(w, index) in watchesTradedFor" :key="w.id">{{index + 1}}. {{w}}</li>
                </ul>
                <b-row no-gutters>
                    <b-col class="px-1">
...
<script>
    ...
    props: ['reasonsWatchMoved', 'removeWatchCount', 'watchIdToRemove'],
    ...
    methods:{
        addWatchTraded() {
            ...
            console.log(this.watchTradedFor)
            this.watchesTradedFor.push(this.watchTradedFor);
            this.watchTradedForBrand = '';
            this.watchTradedForName = '';
        }
    }
